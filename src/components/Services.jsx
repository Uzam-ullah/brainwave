            ...
            <div className='absolute inset-0'>
              ...
              <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]">
                <div className="py-12 px-4 xl:py-8">
                    ...
                    <p className='body-2 mb-[2rem] text-n-3 '>The world's most 
                        powerful AI photo and Video Art generation engine. What you will want to create?</p>
                        <ul className='flex justify-between items-center'>
                            {brainwaveServicesIcons.map((item, index)=>(
                                <li key={index} className={`flex items-center justify-center rounded-2xl ${index===2 ? 'h-[3rem] w-[3rem] p-0.25 bg-conic-gradient  md:w-[4.5rem] md:h-[4.5rem]':'flex h-10 w-10 bg-n-6 md:w-15 md:h-15'}`}>
